...
def test_feature_matching(cfg: DictConfig) -> None:
    ...
    if len(all_features) >= 2:
        ...
        try:
            ...
            matcher.visualize_matches(test_images[0], test_images[1], filtered_matches, vis_filtered_path)
            logger.info(f"Filtered match visualization saved to: {vis_filtered_path}")
